                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link :active="request()->is('/')" aria-current="page" href="/">Home</x-nav-link>
                                ...
                                <x-nav-link :active="request()->is('job')" href="/job">Job</x-nav-link>
                                <x-nav-link :active="request()->is('blog')" href="/blog">Blog</x-nav-link>
                                <x-nav-link :active="request()->is('comments')" href="/comments">Customers Opinions</x-nav-link>
